...
export default class BuyMore extends Component {
	...
	render() {
		...
		return(
			<button style={letterStyle} onMouseOver={this.handleMouseOver.bind(this)} onMouseLeave={this.handleMouseLeave.bind(this)} onClick={this.props.onClick}>BUY MORE!</button>
		);
	}
}