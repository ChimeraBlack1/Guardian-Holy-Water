	...
	render () {
		...
		return(
			<div className="container">
				...
				<p className="tripHoly">The water comes from a spring high in the andes mountains.  It is harvested by a blind priest who brings it down to his village where it sits in a barrel
