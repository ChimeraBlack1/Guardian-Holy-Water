...
export default class Tos extends Component {
	render() {
		return(
			<div className="tos" >
			<h3 className="tosTitle">Terms Of Service</h3>
				<p className="light">You recognize by purchasing this product that it is meant for entertainment purposes only.  You acknowledge that the 
