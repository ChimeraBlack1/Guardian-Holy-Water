...
export default class Tos extends Component {
	render() {
		return(
			<div className="tos" >
				<p>You recognize by purchasing this product that it is meant for entertainment purposes only.  You acknowledge that the 
...
at all in return will be at the sole discretion of the owner of this site.  All returns are subject to a 500% processing fee.</p>
