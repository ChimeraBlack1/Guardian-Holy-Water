...
export default class ChangeAddy extends Component {
    constructor(props) {
      super(props);
	...
	render() {
		...
		return(
			<button style={letterStyle} onMouseOver={this.handleMouseOver.bind(this)} onMouseLeave={this.handleMouseLeave.bind(this)} onClick={this.props.onClick}>Change Address</button>
		);
	}
}